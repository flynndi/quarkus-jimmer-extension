...
a|icon:lock[title=Fixed at build time] [[quarkus-jimmer_quarkus-jimmer-in-list-to-any-equality-enabled]]`link:#quarkus-jimmer_quarkus-jimmer-in-list-to-any-equality-enabled[quarkus.jimmer.in-list-to-any-equality-enabled]`
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_JIMMER_IN_LIST_TO_ANY_EQUALITY_ENABLED+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_JIMMER_IN_LIST_TO_ANY_EQUALITY_ENABLED+++`
endif::add-copy-button-to-env-var[]
--|boolean 
|`false`
