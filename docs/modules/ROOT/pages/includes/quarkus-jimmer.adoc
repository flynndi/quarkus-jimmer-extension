...
a|icon:lock[title=Fixed at build time] [[quarkus-jimmer_quarkus-jimmer-client-openapi-properties-components-security-schemes-security-schemes-type]]`link:#quarkus-jimmer_quarkus-jimmer-client-openapi-properties-components-security-schemes-security-schemes-type[quarkus.jimmer.client.openapi.properties.components.security-schemes."security-schemes".type]`
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_JIMMER_CLIENT_OPENAPI_PROPERTIES_COMPONENTS_SECURITY_SCHEMES__SECURITY_SCHEMES__TYPE+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_JIMMER_CLIENT_OPENAPI_PROPERTIES_COMPONENTS_SECURITY_SCHEMES__SECURITY_SCHEMES__TYPE+++`
endif::add-copy-button-to-env-var[]
--|string 
|


a|icon:lock[title=Fixed at build time] [[quarkus-jimmer_quarkus-jimmer-client-openapi-properties-components-security-schemes-security-schemes-description]]`link:#quarkus-jimmer_quarkus-jimmer-client-openapi-properties-components-security-schemes-security-schemes-description[quarkus.jimmer.client.openapi.properties.components.security-schemes."security-schemes".description]`
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_JIMMER_CLIENT_OPENAPI_PROPERTIES_COMPONENTS_SECURITY_SCHEMES__SECURITY_SCHEMES__DESCRIPTION+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_JIMMER_CLIENT_OPENAPI_PROPERTIES_COMPONENTS_SECURITY_SCHEMES__SECURITY_SCHEMES__DESCRIPTION+++`
endif::add-copy-button-to-env-var[]
--|string 
|


a|icon:lock[title=Fixed at build time] [[quarkus-jimmer_quarkus-jimmer-client-openapi-properties-components-security-schemes-security-schemes-name]]`link:#quarkus-jimmer_quarkus-jimmer-client-openapi-properties-components-security-schemes-security-schemes-name[quarkus.jimmer.client.openapi.properties.components.security-schemes."security-schemes".name]`
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_JIMMER_CLIENT_OPENAPI_PROPERTIES_COMPONENTS_SECURITY_SCHEMES__SECURITY_SCHEMES__NAME+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_JIMMER_CLIENT_OPENAPI_PROPERTIES_COMPONENTS_SECURITY_SCHEMES__SECURITY_SCHEMES__NAME+++`
endif::add-copy-button-to-env-var[]
--|string 
|


a|icon:lock[title=Fixed at build time] [[quarkus-jimmer_quarkus-jimmer-client-openapi-properties-components-security-schemes-security-schemes-in]]`link:#quarkus-jimmer_quarkus-jimmer-client-openapi-properties-components-security-schemes-security-schemes-in[quarkus.jimmer.client.openapi.properties.components.security-schemes."security-schemes".in]`
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_JIMMER_CLIENT_OPENAPI_PROPERTIES_COMPONENTS_SECURITY_SCHEMES__SECURITY_SCHEMES__IN+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_JIMMER_CLIENT_OPENAPI_PROPERTIES_COMPONENTS_SECURITY_SCHEMES__SECURITY_SCHEMES__IN+++`
endif::add-copy-button-to-env-var[]
-- a|
`query`, `header`, `cookie` 
|`header`
...
a|icon:lock[title=Fixed at build time] [[quarkus-jimmer_quarkus-jimmer-client-openapi-properties-components-security-schemes-security-schemes-scheme]]`link:#quarkus-jimmer_quarkus-jimmer-client-openapi-properties-components-security-schemes-security-schemes-scheme[quarkus.jimmer.client.openapi.properties.components.security-schemes."security-schemes".scheme]`
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_JIMMER_CLIENT_OPENAPI_PROPERTIES_COMPONENTS_SECURITY_SCHEMES__SECURITY_SCHEMES__SCHEME+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_JIMMER_CLIENT_OPENAPI_PROPERTIES_COMPONENTS_SECURITY_SCHEMES__SECURITY_SCHEMES__SCHEME+++`
endif::add-copy-button-to-env-var[]
--|string 
|


a|icon:lock[title=Fixed at build time] [[quarkus-jimmer_quarkus-jimmer-client-openapi-properties-components-security-schemes-security-schemes-bearer-format]]`link:#quarkus-jimmer_quarkus-jimmer-client-openapi-properties-components-security-schemes-security-schemes-bearer-format[quarkus.jimmer.client.openapi.properties.components.security-schemes."security-schemes".bearer-format]`
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_JIMMER_CLIENT_OPENAPI_PROPERTIES_COMPONENTS_SECURITY_SCHEMES__SECURITY_SCHEMES__BEARER_FORMAT+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_JIMMER_CLIENT_OPENAPI_PROPERTIES_COMPONENTS_SECURITY_SCHEMES__SECURITY_SCHEMES__BEARER_FORMAT+++`
endif::add-copy-button-to-env-var[]
--|string 
|


a|icon:lock[title=Fixed at build time] [[quarkus-jimmer_quarkus-jimmer-client-openapi-properties-components-security-schemes-security-schemes-flows-implicit-authorization-url]]`link:#quarkus-jimmer_quarkus-jimmer-client-openapi-properties-components-security-schemes-security-schemes-flows-implicit-authorization-url[quarkus.jimmer.client.openapi.properties.components.security-schemes."security-schemes".flows.implicit.authorization-url]`
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_JIMMER_CLIENT_OPENAPI_PROPERTIES_COMPONENTS_SECURITY_SCHEMES__SECURITY_SCHEMES__FLOWS_IMPLICIT_AUTHORIZATION_URL+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_JIMMER_CLIENT_OPENAPI_PROPERTIES_COMPONENTS_SECURITY_SCHEMES__SECURITY_SCHEMES__FLOWS_IMPLICIT_AUTHORIZATION_URL+++`
endif::add-copy-button-to-env-var[]
--|string 
|


a|icon:lock[title=Fixed at build time] [[quarkus-jimmer_quarkus-jimmer-client-openapi-properties-components-security-schemes-security-schemes-flows-implicit-token-url]]`link:#quarkus-jimmer_quarkus-jimmer-client-openapi-properties-components-security-schemes-security-schemes-flows-implicit-token-url[quarkus.jimmer.client.openapi.properties.components.security-schemes."security-schemes".flows.implicit.token-url]`
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_JIMMER_CLIENT_OPENAPI_PROPERTIES_COMPONENTS_SECURITY_SCHEMES__SECURITY_SCHEMES__FLOWS_IMPLICIT_TOKEN_URL+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_JIMMER_CLIENT_OPENAPI_PROPERTIES_COMPONENTS_SECURITY_SCHEMES__SECURITY_SCHEMES__FLOWS_IMPLICIT_TOKEN_URL+++`
endif::add-copy-button-to-env-var[]
--|string 
|


a|icon:lock[title=Fixed at build time] [[quarkus-jimmer_quarkus-jimmer-client-openapi-properties-components-security-schemes-security-schemes-flows-implicit-refresh-url]]`link:#quarkus-jimmer_quarkus-jimmer-client-openapi-properties-components-security-schemes-security-schemes-flows-implicit-refresh-url[quarkus.jimmer.client.openapi.properties.components.security-schemes."security-schemes".flows.implicit.refresh-url]`
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_JIMMER_CLIENT_OPENAPI_PROPERTIES_COMPONENTS_SECURITY_SCHEMES__SECURITY_SCHEMES__FLOWS_IMPLICIT_REFRESH_URL+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_JIMMER_CLIENT_OPENAPI_PROPERTIES_COMPONENTS_SECURITY_SCHEMES__SECURITY_SCHEMES__FLOWS_IMPLICIT_REFRESH_URL+++`
endif::add-copy-button-to-env-var[]
--|string 
|


a|icon:lock[title=Fixed at build time] [[quarkus-jimmer_quarkus-jimmer-client-openapi-properties-components-security-schemes-security-schemes-flows-implicit-scopes-scopes]]`link:#quarkus-jimmer_quarkus-jimmer-client-openapi-properties-components-security-schemes-security-schemes-flows-implicit-scopes-scopes[quarkus.jimmer.client.openapi.properties.components.security-schemes."security-schemes".flows.implicit.scopes]`
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_JIMMER_CLIENT_OPENAPI_PROPERTIES_COMPONENTS_SECURITY_SCHEMES__SECURITY_SCHEMES__FLOWS_IMPLICIT_SCOPES+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_JIMMER_CLIENT_OPENAPI_PROPERTIES_COMPONENTS_SECURITY_SCHEMES__SECURITY_SCHEMES__FLOWS_IMPLICIT_SCOPES+++`
endif::add-copy-button-to-env-var[]
--|`Map<String,String>` 
|


a|icon:lock[title=Fixed at build time] [[quarkus-jimmer_quarkus-jimmer-client-openapi-properties-components-security-schemes-security-schemes-flows-password-authorization-url]]`link:#quarkus-jimmer_quarkus-jimmer-client-openapi-properties-components-security-schemes-security-schemes-flows-password-authorization-url[quarkus.jimmer.client.openapi.properties.components.security-schemes."security-schemes".flows.password.authorization-url]`
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_JIMMER_CLIENT_OPENAPI_PROPERTIES_COMPONENTS_SECURITY_SCHEMES__SECURITY_SCHEMES__FLOWS_PASSWORD_AUTHORIZATION_URL+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_JIMMER_CLIENT_OPENAPI_PROPERTIES_COMPONENTS_SECURITY_SCHEMES__SECURITY_SCHEMES__FLOWS_PASSWORD_AUTHORIZATION_URL+++`
endif::add-copy-button-to-env-var[]
--|string 
|


a|icon:lock[title=Fixed at build time] [[quarkus-jimmer_quarkus-jimmer-client-openapi-properties-components-security-schemes-security-schemes-flows-password-token-url]]`link:#quarkus-jimmer_quarkus-jimmer-client-openapi-properties-components-security-schemes-security-schemes-flows-password-token-url[quarkus.jimmer.client.openapi.properties.components.security-schemes."security-schemes".flows.password.token-url]`
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_JIMMER_CLIENT_OPENAPI_PROPERTIES_COMPONENTS_SECURITY_SCHEMES__SECURITY_SCHEMES__FLOWS_PASSWORD_TOKEN_URL+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_JIMMER_CLIENT_OPENAPI_PROPERTIES_COMPONENTS_SECURITY_SCHEMES__SECURITY_SCHEMES__FLOWS_PASSWORD_TOKEN_URL+++`
endif::add-copy-button-to-env-var[]
--|string 
|


a|icon:lock[title=Fixed at build time] [[quarkus-jimmer_quarkus-jimmer-client-openapi-properties-components-security-schemes-security-schemes-flows-password-refresh-url]]`link:#quarkus-jimmer_quarkus-jimmer-client-openapi-properties-components-security-schemes-security-schemes-flows-password-refresh-url[quarkus.jimmer.client.openapi.properties.components.security-schemes."security-schemes".flows.password.refresh-url]`
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_JIMMER_CLIENT_OPENAPI_PROPERTIES_COMPONENTS_SECURITY_SCHEMES__SECURITY_SCHEMES__FLOWS_PASSWORD_REFRESH_URL+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_JIMMER_CLIENT_OPENAPI_PROPERTIES_COMPONENTS_SECURITY_SCHEMES__SECURITY_SCHEMES__FLOWS_PASSWORD_REFRESH_URL+++`
endif::add-copy-button-to-env-var[]
--|string 
|


a|icon:lock[title=Fixed at build time] [[quarkus-jimmer_quarkus-jimmer-client-openapi-properties-components-security-schemes-security-schemes-flows-password-scopes-scopes]]`link:#quarkus-jimmer_quarkus-jimmer-client-openapi-properties-components-security-schemes-security-schemes-flows-password-scopes-scopes[quarkus.jimmer.client.openapi.properties.components.security-schemes."security-schemes".flows.password.scopes]`
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_JIMMER_CLIENT_OPENAPI_PROPERTIES_COMPONENTS_SECURITY_SCHEMES__SECURITY_SCHEMES__FLOWS_PASSWORD_SCOPES+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_JIMMER_CLIENT_OPENAPI_PROPERTIES_COMPONENTS_SECURITY_SCHEMES__SECURITY_SCHEMES__FLOWS_PASSWORD_SCOPES+++`
endif::add-copy-button-to-env-var[]
--|`Map<String,String>` 
|


a|icon:lock[title=Fixed at build time] [[quarkus-jimmer_quarkus-jimmer-client-openapi-properties-components-security-schemes-security-schemes-flows-client-credentials-authorization-url]]`link:#quarkus-jimmer_quarkus-jimmer-client-openapi-properties-components-security-schemes-security-schemes-flows-client-credentials-authorization-url[quarkus.jimmer.client.openapi.properties.components.security-schemes."security-schemes".flows.client-credentials.authorization-url]`
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_JIMMER_CLIENT_OPENAPI_PROPERTIES_COMPONENTS_SECURITY_SCHEMES__SECURITY_SCHEMES__FLOWS_CLIENT_CREDENTIALS_AUTHORIZATION_URL+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_JIMMER_CLIENT_OPENAPI_PROPERTIES_COMPONENTS_SECURITY_SCHEMES__SECURITY_SCHEMES__FLOWS_CLIENT_CREDENTIALS_AUTHORIZATION_URL+++`
endif::add-copy-button-to-env-var[]
--|string 
|


a|icon:lock[title=Fixed at build time] [[quarkus-jimmer_quarkus-jimmer-client-openapi-properties-components-security-schemes-security-schemes-flows-client-credentials-token-url]]`link:#quarkus-jimmer_quarkus-jimmer-client-openapi-properties-components-security-schemes-security-schemes-flows-client-credentials-token-url[quarkus.jimmer.client.openapi.properties.components.security-schemes."security-schemes".flows.client-credentials.token-url]`
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_JIMMER_CLIENT_OPENAPI_PROPERTIES_COMPONENTS_SECURITY_SCHEMES__SECURITY_SCHEMES__FLOWS_CLIENT_CREDENTIALS_TOKEN_URL+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_JIMMER_CLIENT_OPENAPI_PROPERTIES_COMPONENTS_SECURITY_SCHEMES__SECURITY_SCHEMES__FLOWS_CLIENT_CREDENTIALS_TOKEN_URL+++`
endif::add-copy-button-to-env-var[]
--|string 
|


a|icon:lock[title=Fixed at build time] [[quarkus-jimmer_quarkus-jimmer-client-openapi-properties-components-security-schemes-security-schemes-flows-client-credentials-refresh-url]]`link:#quarkus-jimmer_quarkus-jimmer-client-openapi-properties-components-security-schemes-security-schemes-flows-client-credentials-refresh-url[quarkus.jimmer.client.openapi.properties.components.security-schemes."security-schemes".flows.client-credentials.refresh-url]`
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_JIMMER_CLIENT_OPENAPI_PROPERTIES_COMPONENTS_SECURITY_SCHEMES__SECURITY_SCHEMES__FLOWS_CLIENT_CREDENTIALS_REFRESH_URL+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_JIMMER_CLIENT_OPENAPI_PROPERTIES_COMPONENTS_SECURITY_SCHEMES__SECURITY_SCHEMES__FLOWS_CLIENT_CREDENTIALS_REFRESH_URL+++`
endif::add-copy-button-to-env-var[]
--|string 
|


a|icon:lock[title=Fixed at build time] [[quarkus-jimmer_quarkus-jimmer-client-openapi-properties-components-security-schemes-security-schemes-flows-client-credentials-scopes-scopes]]`link:#quarkus-jimmer_quarkus-jimmer-client-openapi-properties-components-security-schemes-security-schemes-flows-client-credentials-scopes-scopes[quarkus.jimmer.client.openapi.properties.components.security-schemes."security-schemes".flows.client-credentials.scopes]`
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_JIMMER_CLIENT_OPENAPI_PROPERTIES_COMPONENTS_SECURITY_SCHEMES__SECURITY_SCHEMES__FLOWS_CLIENT_CREDENTIALS_SCOPES+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_JIMMER_CLIENT_OPENAPI_PROPERTIES_COMPONENTS_SECURITY_SCHEMES__SECURITY_SCHEMES__FLOWS_CLIENT_CREDENTIALS_SCOPES+++`
endif::add-copy-button-to-env-var[]
--|`Map<String,String>` 
|


a|icon:lock[title=Fixed at build time] [[quarkus-jimmer_quarkus-jimmer-client-openapi-properties-components-security-schemes-security-schemes-flows-authorization-code-authorization-url]]`link:#quarkus-jimmer_quarkus-jimmer-client-openapi-properties-components-security-schemes-security-schemes-flows-authorization-code-authorization-url[quarkus.jimmer.client.openapi.properties.components.security-schemes."security-schemes".flows.authorization-code.authorization-url]`
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_JIMMER_CLIENT_OPENAPI_PROPERTIES_COMPONENTS_SECURITY_SCHEMES__SECURITY_SCHEMES__FLOWS_AUTHORIZATION_CODE_AUTHORIZATION_URL+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_JIMMER_CLIENT_OPENAPI_PROPERTIES_COMPONENTS_SECURITY_SCHEMES__SECURITY_SCHEMES__FLOWS_AUTHORIZATION_CODE_AUTHORIZATION_URL+++`
endif::add-copy-button-to-env-var[]
--|string 
|


a|icon:lock[title=Fixed at build time] [[quarkus-jimmer_quarkus-jimmer-client-openapi-properties-components-security-schemes-security-schemes-flows-authorization-code-token-url]]`link:#quarkus-jimmer_quarkus-jimmer-client-openapi-properties-components-security-schemes-security-schemes-flows-authorization-code-token-url[quarkus.jimmer.client.openapi.properties.components.security-schemes."security-schemes".flows.authorization-code.token-url]`
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_JIMMER_CLIENT_OPENAPI_PROPERTIES_COMPONENTS_SECURITY_SCHEMES__SECURITY_SCHEMES__FLOWS_AUTHORIZATION_CODE_TOKEN_URL+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_JIMMER_CLIENT_OPENAPI_PROPERTIES_COMPONENTS_SECURITY_SCHEMES__SECURITY_SCHEMES__FLOWS_AUTHORIZATION_CODE_TOKEN_URL+++`
endif::add-copy-button-to-env-var[]
--|string 
|


a|icon:lock[title=Fixed at build time] [[quarkus-jimmer_quarkus-jimmer-client-openapi-properties-components-security-schemes-security-schemes-flows-authorization-code-refresh-url]]`link:#quarkus-jimmer_quarkus-jimmer-client-openapi-properties-components-security-schemes-security-schemes-flows-authorization-code-refresh-url[quarkus.jimmer.client.openapi.properties.components.security-schemes."security-schemes".flows.authorization-code.refresh-url]`
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_JIMMER_CLIENT_OPENAPI_PROPERTIES_COMPONENTS_SECURITY_SCHEMES__SECURITY_SCHEMES__FLOWS_AUTHORIZATION_CODE_REFRESH_URL+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_JIMMER_CLIENT_OPENAPI_PROPERTIES_COMPONENTS_SECURITY_SCHEMES__SECURITY_SCHEMES__FLOWS_AUTHORIZATION_CODE_REFRESH_URL+++`
endif::add-copy-button-to-env-var[]
--|string 
|


a|icon:lock[title=Fixed at build time] [[quarkus-jimmer_quarkus-jimmer-client-openapi-properties-components-security-schemes-security-schemes-flows-authorization-code-scopes-scopes]]`link:#quarkus-jimmer_quarkus-jimmer-client-openapi-properties-components-security-schemes-security-schemes-flows-authorization-code-scopes-scopes[quarkus.jimmer.client.openapi.properties.components.security-schemes."security-schemes".flows.authorization-code.scopes]`
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_JIMMER_CLIENT_OPENAPI_PROPERTIES_COMPONENTS_SECURITY_SCHEMES__SECURITY_SCHEMES__FLOWS_AUTHORIZATION_CODE_SCOPES+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_JIMMER_CLIENT_OPENAPI_PROPERTIES_COMPONENTS_SECURITY_SCHEMES__SECURITY_SCHEMES__FLOWS_AUTHORIZATION_CODE_SCOPES+++`
endif::add-copy-button-to-env-var[]
--|`Map<String,String>` 
|


a|icon:lock[title=Fixed at build time] [[quarkus-jimmer_quarkus-jimmer-client-openapi-properties-components-security-schemes-security-schemes-open-id-connect-url]]`link:#quarkus-jimmer_quarkus-jimmer-client-openapi-properties-components-security-schemes-security-schemes-open-id-connect-url[quarkus.jimmer.client.openapi.properties.components.security-schemes."security-schemes".open-id-connect-url]`
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_JIMMER_CLIENT_OPENAPI_PROPERTIES_COMPONENTS_SECURITY_SCHEMES__SECURITY_SCHEMES__OPEN_ID_CONNECT_URL+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_JIMMER_CLIENT_OPENAPI_PROPERTIES_COMPONENTS_SECURITY_SCHEMES__SECURITY_SCHEMES__OPEN_ID_CONNECT_URL+++`
endif::add-copy-button-to-env-var[]
--|string 
|
