...
public final class QuarkusJSqlClientContainerUtil {
    ...
    public static JQuarkusSqlClientContainer getQuarkusJSqlClientContainer(String dataSourceName) {
        return instantiateBeanOrClass(JQuarkusSqlClientContainer.class, getQuarkusJSqlClientContainerQualifier(dataSourceName));
    }
