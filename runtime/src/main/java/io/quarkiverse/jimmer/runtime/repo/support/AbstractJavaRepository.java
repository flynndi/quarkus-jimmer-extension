...
public class AbstractJavaRepository<E, ID> implements JavaRepository<E, ID> {
    ...
    @Override
    public BatchSaveResult<E> saveEntities(Collection<E> entities, SaveMode rootSaveMode,
    ...
    @Override
    public BatchSaveResult<E> saveInputs(Collection<Input<E>> inputs, SaveMode rootSaveMode,
            AssociatedSaveMode associatedSaveMode) {
        return sqlClient
                .getEntities()
