...
Gradle
```groovy
implementation 'io.github.flynndi:quarkus-jimmer:0.0.1.CR29'
annotationProcessor 'org.babyfish.jimmer:jimmer-apt:0.8.184'
```
Maven
```xml
<dependency>
