...
Gradle
```groovy
implementation 'io.github.flynndi:quarkus-jimmer:0.0.1.CR23'
annotationProcessor 'org.babyfish.jimmer:jimmer-apt:0.8.158'
```
Maven
```xml
<dependency>
