...
Gradle
```groovy
implementation 'io.github.flynndi:quarkus-jimmer:0.0.1.CR24'
annotationProcessor 'org.babyfish.jimmer:jimmer-apt:0.8.163'
```
Maven
```xml
<dependency>
