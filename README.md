...
Gradle
```groovy
implementation 'io.github.flynndi:quarkus-jimmer:0.0.1.CR14'
annotationProcessor 'org.babyfish.jimmer:jimmer-apt:0.8.132'
```
Maven
```xml
<dependency>
