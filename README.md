...
Gradle
```groovy
implementation 'io.github.flynndi:quarkus-jimmer:0.0.1.CR25'
annotationProcessor 'org.babyfish.jimmer:jimmer-apt:0.8.165'
```
Maven
```xml
<dependency>
