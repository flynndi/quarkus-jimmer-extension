...
Gradle
```groovy
implementation 'io.github.flynndi:quarkus-jimmer:0.0.1.CR22'
annotationProcessor 'org.babyfish.jimmer:jimmer-apt:0.8.155'
```
Maven
```xml
<dependency>
