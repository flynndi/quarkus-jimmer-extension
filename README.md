...
Gradle
```groovy
implementation 'io.github.flynndi:quarkus-jimmer:0.0.1.CR18'
annotationProcessor 'org.babyfish.jimmer:jimmer-apt:0.8.140'
```
Maven
```xml
<dependency>
