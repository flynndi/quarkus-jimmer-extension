...
Gradle
```groovy
implementation 'io.github.flynndi:quarkus-jimmer:0.0.1.CR28'
annotationProcessor 'org.babyfish.jimmer:jimmer-apt:0.8.179'
```
Maven
```xml
<dependency>
