...
Gradle
```groovy
implementation 'io.github.flynndi:quarkus-jimmer:0.0.1.CR26'
annotationProcessor 'org.babyfish.jimmer:jimmer-apt:0.8.170'
```
Maven
```xml
<dependency>
