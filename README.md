...
Gradle
```groovy
implementation 'io.github.flynndi:quarkus-jimmer:0.0.1.CR15'
annotationProcessor 'org.babyfish.jimmer:jimmer-apt:0.8.133'
```
Maven
```xml
<dependency>
