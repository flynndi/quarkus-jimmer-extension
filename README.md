...
Gradle
```groovy
implementation 'io.github.flynndi:quarkus-jimmer:0.0.1.CR19'
annotationProcessor 'org.babyfish.jimmer:jimmer-apt:0.8.147'
```
Maven
```xml
<dependency>
