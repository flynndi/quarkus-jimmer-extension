...
public class GraphQLConfig {
    ...
    public RuntimeWiringConfigurer jimmerRuntimeWiringConfigurer() {
        return GraphQLConfig::registerJimmerDataFetchers;
    }

    private static void registerJimmerDataFetchers(
            RuntimeWiring.Builder wiringBuilder) {
        EntityManager entityManager = EntityManager.fromResources(Thread.currentThread().getContextClassLoader(), null);
